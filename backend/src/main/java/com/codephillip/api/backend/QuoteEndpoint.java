package com.codephillip.api.backend;
...
import static com.codephillip.api.backend.OfyService.ofy;

@Api(name = "quoteEndpoint", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.api.codephillip.com", ownerName = "backend.api.codephillip.com", packagePath=""))
