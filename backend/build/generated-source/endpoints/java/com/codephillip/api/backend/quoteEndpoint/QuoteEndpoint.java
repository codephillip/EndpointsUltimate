 ...
 * on 2016-06-30 at 07:23:38 UTC 
 * Modify at your own risk.
 */

package com.codephillip.api.backend.quoteEndpoint;
...
public class QuoteEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://endpointsapp-1007.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.codephillip.api.backend.quoteEndpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.codephillip.api.backend.quoteEndpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteEndpointRequest<com.codephillip.api.backend.quoteEndpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.codephillip.api.backend.quoteEndpoint.model.Quote content) {
      super(QuoteEndpoint.this, "POST", REST_PATH, content, com.codephillip.api.backend.quoteEndpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteEndpointRequest<com.codephillip.api.backend.quoteEndpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(QuoteEndpoint.this, "GET", REST_PATH, null, com.codephillip.api.backend.quoteEndpoint.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.codephillip.api.backend.quoteEndpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteEndpointRequest<com.codephillip.api.backend.quoteEndpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.codephillip.api.backend.quoteEndpoint.model.Quote content) {
      super(QuoteEndpoint.this, "PUT", REST_PATH, content, com.codephillip.api.backend.quoteEndpoint.model.Quote.class);
    }
